...
STAGE1_ITERATIONS="${N2_FASTSTAIR_STAGE1_ITERATIONS:-600}"
STAGE2_ITERATIONS="${N2_FASTSTAIR_STAGE2_ITERATIONS:-800}"
STAGE3_ITERATIONS="${N2_FASTSTAIR_STAGE3_ITERATIONS:-1000}"
...
STAGE2_REFERENCE="${N2_FASTSTAIR_STAGE2_REFERENCE:-0.005}"
STAGE3_REFERENCE="${N2_FASTSTAIR_STAGE3_REFERENCE:-0.002}"
STAGE1_REWARD_OVERRIDES="${N2_FASTSTAIR_STAGE1_REWARDS:-stairs_completion=2,stairs_curriculum_completion=10,faststair_liftoff=4,faststair_swing_progress=3,stairs_phase_contact=2,stairs_phase_contact_mismatch=-3,stairs_alternating_tread=0.5,stairs_repeated_lead=0,stairs_same_tread_join=0,stairs_same_tread_support=0,stairs_paired_lead_advance=8,stairs_paired_trailing_join=10,stairs_paired_sequence_error=-8,stairs_skipped_tread=-5,stairs_sagittal_foot_phase=0.5,stairs_sagittal_foot_phase_error=-0.3,stairs_stride_symmetry=-0.5,stairs_sole_support_error=-3,stairs_right_stride_excess=0,stairs_right_stride_excess_continuous=0,stairs_swing_timeout=-3,stairs_foothold_lateral=0.75,stairs_foothold_lateral_error=-0.75,stairs_foot_crossover=-3,stairs_foot_lane_error=-1,stairs_single_support_stability=-0.75,stairs_right_support_stability=-1,action_rate=-0.12,action_smoothness=-0.12}"
STAGE2_REWARD_OVERRIDES="${N2_FASTSTAIR_STAGE2_REWARDS:-faststair_foothold=8,faststair_foothold_error=-8,stairs_alternating_tread=0.5,stairs_repeated_lead=0,stairs_same_tread_join=0,stairs_same_tread_support=0,stairs_paired_lead_advance=8,stairs_paired_trailing_join=10,stairs_paired_sequence_error=-8,stairs_skipped_tread=-6,stairs_sagittal_foot_phase=0.75,stairs_sagittal_foot_phase_error=-0.35,stairs_stride_symmetry=-0.5,stairs_sole_support_error=-4,stairs_right_stride_excess=0,stairs_right_stride_excess_continuous=0,stairs_foothold_lateral=1,stairs_foothold_lateral_error=-1,stairs_foot_crossover=-4,stairs_foot_lane_error=-1.5,stairs_single_support_stability=-1.25,stairs_right_support_stability=-1.75,action_rate=-0.15,action_smoothness=-0.15}"
STAGE3_REWARD_OVERRIDES="${N2_FASTSTAIR_STAGE3_REWARDS:-faststair_foothold=10,faststair_foothold_error=-10,stairs_alternating_tread=0.5,stairs_repeated_lead=0,stairs_same_tread_join=0,stairs_same_tread_support=0,stairs_paired_lead_advance=10,stairs_paired_trailing_join=12,stairs_paired_sequence_error=-10,stairs_skipped_tread=-8,stairs_sagittal_foot_phase=1,stairs_sagittal_foot_phase_error=-0.5,stairs_stride_symmetry=-0.75,stairs_sole_support_error=-5,stairs_right_stride_excess=0,stairs_right_stride_excess_continuous=0,stairs_foothold_lateral=1.25,stairs_foothold_lateral_error=-1.25,stairs_foot_crossover=-5,stairs_foot_lane_error=-2,stairs_single_support_stability=-2,stairs_right_support_stability=-3,action_rate=-0.18,action_smoothness=-0.18}"
...
run_training() {
    ...
    echo "FASTSTAIR_GAIT_MODE paired_step_to preferred_lead=right natural_alternation_allowed=True"
    echo "FASTSTAIR_ANTI_CHEAT paired_state_gate=True premature_advance_penalty=True actual_sole_support_gate=True"
    echo "FASTSTAIR_SIGNAL_ALIGNMENT contact_phase_reset=True planner_uses_pair_state=True reflection_symmetry_disabled=True"

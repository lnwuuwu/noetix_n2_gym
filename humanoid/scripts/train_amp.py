...
def train(args):
    ...
    if args.resume and not args.model_path and ppo_runner.current_learning_iteration <= 0:
        raise RuntimeError(
        ...
        [
            {
                ...
                "type": str,
                "default": "",
                "help": "Direct path to model best checkpoint to load",
            },
            {
                "name": "--motion_file",
                "type": str,
                "default": "",
                "help": "Path to reference motion json",
            },
            {
